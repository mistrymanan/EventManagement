    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(max_length=100, null=True, on_delete=django.db.models.deletion.SET_NULL, to='Profile.events')),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
        ...
        migrations.AddField(
            model_name='events',
            name='venue',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='Profile.venue'),
        ),
    ]
